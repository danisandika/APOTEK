            ...
            <div class="card-body">
              <div class="tab-content">
                <div class="active tab-pane" id="activity">
                  ...
                  <hr>
                  <form class="" action="<?php echo site_url('CMPembelian/rPembelian') ?>" method="post">
                    <div class="row">
                    <div class="col-md-3">
                  ...
                  <table id="table1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td><?php $i++; echo $i?></td>
                          <td><?php echo $s->IDPembelian?></td>
                          <td><?php echo $s->NamaSupplier ?></td>
                          <td><?php echo $s->Tanggal?></td>
                          <td align="right">Rp.<?php echo number_format($s->totalBayar)?></td>
                          <td><a href="#" class="btn btn-primary btn-sm view_pembelian" relid="<?php echo $s->IDPembelian;  ?>"><span class="fas fa-eye"></span> | Details</a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
                  <div class="form-group">
                    <label for="inputName" class="col-sm-12 control-label">&nbsp;</label>
                    <div class="col-sm-12">
                    <a href="<?php echo site_url('CMPembelian/create_pdf/'.base64_encode(serialize($pembelian))); ?>" class="btn btn-success float-right"><span class="fas fa-print">&nbsp;</span>| Print</a>
                    </div>
                  </div>
                </div>
                <!-- /.tab-pane -->
                <div class="tab-pane" id="timeline">
                  ...
                  <div class="card card-info">
                    ...
                    <div class="card-body">
                      <div class="chart">
                        <canvas id="areaChartPembelian" style="height:500px; min-height:500px"></canvas>
                      </div>
                    </div>
                    <!-- /.card-body -->
                  </div>
