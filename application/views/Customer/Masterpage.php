...
<head>
  ...
  <link href="<?php echo base_url('Medicio/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css')?>">
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
      <div class="top-area">
			...
			<div class="cta-btn">
			  <a href="<?php echo site_url('CLogin/')?>" class="btn btn-skin btn-lg">Login/Register</a>
			</div>  
      ...
      <div class="container navigation">
        ...
        <div class="navbar-header page-scroll">
          ...
          <a class="navbar-brand" href="index.html">
                    <img src="<?php echo base_url('Medicio/img/logo1.png" alt="" width="150" height="60"')?>">
                </a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#doctor">Pharmacist</a></li>
            <li><a href="#facilities">Products</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                <img src="<?php echo base_url('Medicio/img/dummy/img-1.png" class="img-responsive" alt="" ')?>">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <img src="<?php echo base_url('Medicio/img/dummy/img-1.jpg" class="img-responsive" alt="" ')?>">
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
          ...
          <div class="col-lg-8 col-lg-offset-2">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="section-heading text-center">
                <h2 class="h-bold">Pharmacist</h2>
                <p>The best and experienced pharmacists with us</p>
              </div>
            </div>
                ...
                <li class="cbp-item psychiatrist">
                  <a href="doctors/member1.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="<?php echo base_url('Medicio/img/team/1.jpg" alt="" width="100%"')?>"> </img>
                    </div>
                  ...
                  <a href="<?php echo base_url('Medicio/doctors/member1.html" class="cbp-singlePage cbp-l-grid-team-name')?>">Alice Grue</a>
                  <div class="cbp-l-grid-team-position">Psychiatrist</div>
                </li>
                <li class="cbp-item cardiologist">
                  <a href="<?php echo base_url('Medicio/doctors/member2.html" class="cbp-caption cbp-singlePage')?>">
                    <div class="cbp-caption-defaultWrap">
      ...
      <div class="container marginbot-50">
        <div class="row">
          <div class="col-lg-8 col-lg-offset-2">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="section-heading text-center">
                <h2 class="h-bold">Our superior products</h2>
                <p>Products available and have good quality</p>
              </div>
            </div>
            <div class="divider-short"></div>
          </div>
            ...
            <div class="wow bounceInUp" data-wow-delay="0.2s">
              <div id="owl-works" class="owl-carousel">
				 <?php
                        ...
                        $sql = mysqli_query($connect,"SELECT * FROM obat WHERE status = '1' ORDER BY IDObat ASC");
                        if(mysqli_num_rows($sql) > 0){
                            while($row = mysqli_fetch_array($sql)) { ?>
							    <div class="item"><a href="<?php echo $row ['Foto'] ?>" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1@2x.jpg"><img src="<?php echo $row ['Foto'] ?>" class="img-responsive" alt="img"></a></div>
                            <?php } ?>
                        <?php } ?>				
               </div>
            </div>
                ...
                <div class="item active">
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="person-text rel text-light">
                      <img src="<?php echo base_url('Medicio/img/testimonials/1.jpg" alt="" class="person img-circle" ')?>">
                      <a title="" href="#">Anna</a>
                  ...
                  <div class="col-md-4 col-sm-6 hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="<?php echo base_url('Medicio/img/testimonials/2.jpg" alt="" class="person img-circle"')?>">
                  ...
                  <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="<?php echo base_url('Medicio/img/testimonials/3.jpg" alt="" class="person img-circle"')?>">
    ...
    <!-- Section: testimonial -->				
     <!--          <div class="item">
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="person-text rel text-light">
                      <img src="<?php echo base_url('Medicio/img/testimonials/4.jpg" alt="" class="person img-circle"')?>">
                  ...
                  <div class="col-md-4 col-sm-6 hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="<?php echo base_url('Medicio/img/testimonials/5.jpg" alt="" class="person img-circle" ')?>">
                  ...
                  <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="<?php echo base_url('Medicio/img/testimonials/6.jpg" alt="" class="person img-circle" ')?>">
