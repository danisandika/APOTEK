...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'pendekarbayangan66@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Apotek Mustika Farma'; // Isikan dengan nama pengirim
    protected $password = 'praditya'; // Isikan dengan password email pengirim
